...
## GFP_linker vs rest LFC 1.5
```{r test_3}
# Test every sample versus control
data_diff_2 <- test_diff(data_imp, type = "control", control = "GFP_link")
##Tested contrasts: parental_vs_GFP_link, cand1_vs_GFP_link, cand2_vs_GFP_link, cand11_vs_GFP_link, cand12_vs_GFP_link, cand16_vs_GFP_link, cand19_vs_GFP_link
...
# Denote significant proteins based on user defined cutoffs, vs control
dep_3 <- add_rejections(data_diff_2, alpha = 0.05, lfc = log2(1.5))
#OR
# Denote significant proteins based on user defined cutoffs, vs all
#dep <- add_rejections(data_diff_all_contrasts, alpha = 0.05, lfc = log2(1.5)) 

# Plot the first and second principal components
plot_pca(dep_3, x = 1, y = 2, n = 54, point_size = 4)

# Plot the Pearson correlation matrix
plot_cor(dep_3, significant = TRUE, lower = 0, upper = 1, pal = "Reds")

# Plot a heatmap of all significant proteins with the data centered per protein
plot_heatmap(dep_3, type = "centered", kmeans = TRUE, 
             k = 3, col_limit = 4, show_row_names = FALSE,
             indicate = c("condition", "replicate"))

# Plot a heatmap of all significant proteins (rows) and the tested contrasts (columns)
plot_heatmap(dep_3, type = "contrast", kmeans = TRUE, 
             k = 3, col_limit = 10, show_row_names = FALSE)

# Plot a volcano plot for the contrast " vs Ctrl""
#pdf('20231027_allvsGFPlink_filt3out6reps_NOnorm_imp_min_lfc_1_5.pdf')
plot_volcano(dep_3, contrast = "parental_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_3, contrast = "cand1_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_3, contrast = "cand2_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_3, contrast = "cand11_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_3, contrast = "cand12_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_3, contrast = "cand16_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_3, contrast = "cand19_vs_GFP_link", label_size = 2, add_names = TRUE)
#dev.off()

# Generate a results table
data_results <- get_results(dep_3)

#save the results table
#write.table(data_results, "20231027_allvsGFPlink_filt3out6reps_NOnorm_imp_min_lfc_1_5.txt", sep="\t")
```

## GFP_linker vs rest LFC 1
```{r test_4}
# Test every sample versus control
data_diff_2 <- test_diff(data_imp, type = "control", control = "GFP_link")
##Tested contrasts: parental_vs_GFP_link, cand1_vs_GFP_link, cand2_vs_GFP_link, cand11_vs_GFP_link, cand12_vs_GFP_link, cand16_vs_GFP_link, cand19_vs_GFP_link
...
# Denote significant proteins based on user defined cutoffs, vs control
dep_4 <- add_rejections(data_diff_2, alpha = 0.05, lfc = log2(1))
#OR
# Denote significant proteins based on user defined cutoffs, vs all
#dep <- add_rejections(data_diff_all_contrasts, alpha = 0.05, lfc = log2(1.5)) 

# Plot the first and second principal components
plot_pca(dep_4, x = 1, y = 2, n = 54, point_size = 4)

# Plot the Pearson correlation matrix
plot_cor(dep_4, significant = TRUE, lower = 0, upper = 1, pal = "Reds")

# Plot a heatmap of all significant proteins with the data centered per protein
plot_heatmap(dep_4, type = "centered", kmeans = TRUE, 
             k = 3, col_limit = 4, show_row_names = FALSE,
             indicate = c("condition", "replicate"))

# Plot a heatmap of all significant proteins (rows) and the tested contrasts (columns)
plot_heatmap(dep_4, type = "contrast", kmeans = TRUE, 
             k = 3, col_limit = 10, show_row_names = FALSE)

# Plot a volcano plot for the contrast " vs Ctrl""
#pdf('20231027_allvsGFPlink_filt3out6reps_NOnorm_imp_min_lfc_1.pdf')
plot_volcano(dep_4, contrast = "parental_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_4, contrast = "cand1_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_4, contrast = "cand2_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_4, contrast = "cand11_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_4, contrast = "cand12_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_4, contrast = "cand16_vs_GFP_link", label_size = 2, add_names = TRUE)
plot_volcano(dep_4, contrast = "cand19_vs_GFP_link", label_size = 2, add_names = TRUE)
#dev.off()

# Generate a results table
data_results <- get_results(dep_4)

#save the results table
#write.table(data_results, "20231027_allvsGFPlink_filt3out6reps_NOnorm_imp_min_lfc_1.txt", sep="\t")
```