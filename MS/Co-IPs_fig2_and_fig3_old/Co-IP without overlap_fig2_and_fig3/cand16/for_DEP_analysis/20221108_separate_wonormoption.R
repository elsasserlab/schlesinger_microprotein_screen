...
setwd("~/Desktop/Mass_Spec/20221108/2_3_injection/20221108_16GFP_noMSMS_allreps")
#20221108----
# load data
my_data <- read.delim("proteinGroups.txt")
data <-my_data
colnames(data) # use this to make experimental design file
experimental_design <- read.delim("20221108_experiment_separate.txt")
...
#metadata(0):
#  assays(1): ''
#rownames(758): IGHV3-72 ILVBL ... CEPT1 IGF2BP2
#rowData names(148): Protein.IDs Majority.protein.IDs ... name ID
#colnames(16): cand16_1 cand16_2 ... parental_7 parental_8
...
#vsn2: 293 x 16 matrix (1 stratum). 
# Please use 'meanSdPlot' to verify the fit.

# Visualize normalization by boxplots for all samples before and after normalization
#plot_normalization(data_filt, data_norm)
#---> does not look much different so don't normalize (anyways Maxquant already does thsi)
...
#=> so from this looks like the ones with missing values have lower intensity
...
pdf('20221108__plotted230301_separate_allvsall_3out4_NOnorm_imp_min_lfc_1_5.pdf')
plot_volcano(dep, contrast = "cand16_harsh_vs_parental_harsh", label_size = 2, add_names = TRUE)
plot_volcano(dep, contrast = "cand16_pbs_vs_parental_pbs", label_size = 2, add_names = TRUE)
plot_volcano(dep, contrast = "cand16_harsh_vs_cand16_pbs", label_size = 2, add_names = TRUE)
plot_volcano(dep, contrast = "parental_harsh_vs_parental_pbs", label_size = 2, add_names = TRUE)
dev.off()
...
write.table(data_results,"20221108__plotted230301_separate_allvsall_3out4_NOnorm_imp_min_lfc_1_5.txt", sep="\t")
