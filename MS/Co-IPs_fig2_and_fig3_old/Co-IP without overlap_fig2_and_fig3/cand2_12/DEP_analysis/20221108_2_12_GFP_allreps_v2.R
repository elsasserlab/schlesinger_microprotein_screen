...
setwd("~/Desktop/Mass_Spec/20221108/2_3_injection/20221108_GFP_2_12_noMSMS_allreps")
...
experimental_design <- read.delim("20221108_experiment_2_12_GFP_hexuplicate.txt")
...
#metadata(0):
#  assays(1): ''
#rownames(1197): UBE2QL1 DDT ... SQRDL AP1M2
#rowData names(162): Protein.IDs Majority.protein.IDs ... name ID
#colnames(18): cand2_1 cand2_2 ... parental_5 parental_6
...
#data_filt <- filter_missval(data_se, thr = )
...
pdf('20221108_2_12_filtallreps_NOnorm_imp_min_lfc_1_5.pdf')
...
write.table(data_results, "20221108_2_12_filtallreps_NOnorm_imp_min_lfc_1_5.txt", sep="\t")
