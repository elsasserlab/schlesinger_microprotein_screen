---
title: "20231210 MS analysis of 16 knockin PBS Co-IP"
...
#pdf('20231210_16KI_vs_parental_filt3out6reps_NOnorm_imp_min_lfc_1_5_PBS.pdf')
...
#write.table(data_results, "20231210_16KI_vs_parental_filt3out6reps_NOnorm_imp_min_lfc_1_5_PBS.txt", sep="\t")
```
...
# Plot a volcano plot for the contrast " vs Ctrl""
#pdf('20231210_16KI_vs_parental_filt3out6reps_NOnorm_imp_min_lfc_1_PBS.pdf')
...
#save the results table
#write.table(data_results_2, "20231210_16KI_vs_parental_filt3out6reps_NOnorm_imp_min_lfc_1_PBS.txt", sep="\t")
```
...
# Plot a volcano plot for the contrast " vs Ctrl""
#pdf('20231210_16KI_vs_parental_filt3out6reps_norm_imp_min_lfc_1.5_PBS.pdf')
...
#save the results table
#write.table(data_results_norm, "20231210_16KI_vs_parental_filt3out6reps_norm_imp_min_lfc_1.5_PBS.txt", sep="\t")
```
...
# Plot a volcano plot for the contrast " vs Ctrl""
#pdf('20231210_16KI_vs_parental_filt3out6reps_norm_imp_min_lfc_1_PBS.pdf')
...
#save the results table
#write.table(data_results_norm_2 , "20231210_16KI_vs_parental_filt3out6reps_norm_imp_min_lfc_1_PBS.txt", sep="\t")
```