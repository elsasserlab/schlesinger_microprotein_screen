---
title: "20231210 MS analysis of Co-IP"
...
plot_volcano(dep, contrast = "GFP_link_vs_parental", label_size = 2, add_names = TRUE) + ggtitle("SFig 7F")
plot_volcano(dep, contrast = "cand1_vs_parental", label_size = 2, add_names = TRUE) + ggtitle("Fig 3A")
plot_volcano(dep, contrast = "cand2_vs_parental", label_size = 2, add_names = TRUE) + ggtitle("SFig 7D bottom")
plot_volcano(dep, contrast = "cand11_vs_parental", label_size = 2, add_names = TRUE) + ggtitle("SFig 7B bottom")
plot_volcano(dep, contrast = "cand12_vs_parental", label_size = 2, add_names = TRUE) + ggtitle("SFig 7E bottom")
plot_volcano(dep, contrast = "cand16_vs_parental", label_size = 2, add_names = TRUE) + ggtitle("Fig 2F")
plot_volcano(dep, contrast = "cand19_vs_parental", label_size = 2, add_names = TRUE) + ggtitle("SFig 7C bottom")
dev.off()
...
```{r}
write.table(data_results[data_results$cand1_vs_parental_significant & data_results$cand1_vs_parental_ratio>1.5,c(1,2,grep("cand1_",colnames(data_results)))],"20231210_cand1.txt", sep="\t", quote = F) 

write.table(data_results[data_results$cand2_vs_parental_significant & data_results$cand2_vs_parental_ratio>1.5,c(1,2,grep("cand2_",colnames(data_results)))],"20231210_cand2.txt", sep="\t", quote = F)

write.table(data_results[data_results$cand11_vs_parental_significant & data_results$cand11_vs_parental_ratio>1.5,c(1,2,grep("cand11_",colnames(data_results)))],"20231210_cand11.txt", sep="\t", quote = F)

write.table(data_results[data_results$cand12_vs_parental_significant & data_results$cand12_vs_parental_ratio>1.5,c(1,2,grep("cand12_",colnames(data_results)))],"20231210_cand12.txt", sep="\t", quote = F)

write.table(data_results[data_results$cand16_vs_parental_significant & data_results$cand16_vs_parental_ratio>1.5,c(1,2,grep("cand16_",colnames(data_results)))],"20231210_cand16.txt", sep="\t", quote = F)

write.table(data_results[data_results$cand19_vs_parental_significant & data_results$cand19_vs_parental_ratio>1.5,c(1,2,grep("cand19_",colnames(data_results)))],"20231210_cand19.txt", sep="\t", quote = F)
```


```{r manual collector}
all.sig <- readRDS("../../list_all.sig.RData")
all.sig$cand1.3 <- data_results[data_results$cand1_vs_parental_significant & data_results$cand1_vs_parental_ratio>1.5,1]
all.sig$cand2.3 <- data_results[data_results$cand2_vs_parental_significant & data_results$cand2_vs_parental_ratio>1.5,1]
all.sig$cand11.3 <- data_results[data_results$cand11_vs_parental_significant & data_results$cand11_vs_parental_ratio>1.5,1]
all.sig$cand12.3 <- data_results[data_results$cand12_vs_parental_significant & data_results$cand12_vs_parental_ratio>1.5,1]
all.sig$cand16.3 <- data_results[data_results$cand16_vs_parental_significant & data_results$cand16_vs_parental_ratio>1.5,1]
all.sig$cand19.3 <- data_results[data_results$cand19_vs_parental_significant & data_results$cand19_vs_parental_ratio>1.5,1]
all.sig$link.3 <- data_results[data_results$GFP_link_vs_parental_significant & data_results$GFP_link_vs_parental_ratio>1.5,1]
```
